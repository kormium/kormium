...
class RowLockingIntegrationTest {
    ...
    private fun io.github.kormium.ScopeOf<LockCatalog, io.github.kormium.PostgresBackend>.claimBatch(size: Int): List<Int> {
    ...
    private fun database(): PostgresDatabase<LockCatalog> = ItDatabase.newDriver(poolSize = 4)

    private fun seed(db: PostgresDatabase<LockCatalog>, count: Int) {
        db.autocommit {
            executeUpdate(
